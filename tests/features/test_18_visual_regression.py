...
def main():
    runner = TestRunner("test_18_visual_regression")
    with sync_playwright() as p:
        browser = p.chromium.launch(headless=True)
        for test_func in [
            test_page_screenshot_comparison,
            test_element_screenshot_comparison,
            test_full_page_screenshot_comparison,
            test_screenshot_with_max_diff_pixels,
            test_screenshot_with_max_diff_pixel_ratio,
            test_screenshot_with_custom_name,
            test_element_screenshot_with_custom_name,
        ]:
