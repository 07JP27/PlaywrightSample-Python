...
def main():
    runner = TestRunner("test_13_shadow_dom")
    with sync_playwright() as p:
        browser = p.chromium.launch(headless=True)
        for test_func in [
            test_shadow_dom_access,
            test_shadow_dom_nested,
            test_shadow_dom_css_selector,
            test_shadow_dom_text_content,
            test_shadow_dom_inner_text,
            test_shadow_dom_get_by_text,
            test_shadow_dom_click,
            test_shadow_dom_checkbox_toggle,
            test_shadow_dom_input,
            test_shadow_dom_get_by_role_button,
            test_shadow_dom_get_by_role_textbox,
            test_shadow_dom_get_by_role_heading,
            test_shadow_dom_get_by_role_link,
        ]:
